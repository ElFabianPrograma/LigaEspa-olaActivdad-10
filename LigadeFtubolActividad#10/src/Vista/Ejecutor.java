        ...
        while (!salir){
            ...
            switch (opcion){
                ...
                case 6:   
                    salir=true;
                default:
                    System.out.println("Las opciones son entre el 1 - 6");
        }
...
public static void RegistrarEquipos() throws IOException{
       System.out.println("~~~Registro de Equipos~~~");
        String Equipo = Lector.leerString("Nombre del Equipo: ");
        int jug = Lector.leerEntero("Ingrese partidos jugados: ");
        int gan = Lector.leerEntero("Ingrese partidos ganados: ");
        int emp = Lector.leerEntero("Ingrese partidos empatados: ");
        int per = Lector.leerEntero("Ingrese partidos perdidos: ");
        int pts = (gan * 3) + (emp * 1);
        
        LigaEspañola LIGAE = new LigaEspañola(Equipo, jug, gan, emp, per, pts);
...
public static void buscar() throws IOException{
    String Equipo = Lector.leerString("Ingrese el nombre a buscar: ");
    LigaEspañola buscado = registro.buscar(Equipo);
            if(buscado!=null){ // 
                ...
                System.out.println("El Equipo con nombre "+Equipo+" no se encuentra en el archivo");
            }
}


public static void eliminar() throws IOException{
    String Equipo = Lector.leerString("Ingrese el nombre de equipo a eliminar: ");
    LigaEspañola eliminado = registro.eliminar(Equipo);
            if(eliminado!=null){ // 
                ...
                System.out.println("El Equipo de nombre "+Equipo+" no se encuentra en el archivo");
            }
}

public static void modificar() throws IOException{
    String Equipo = Lector.leerString("Ingrese el nombre de equipo a modificar: ");
    LigaEspañola eliminado = registro.eliminar(Equipo);
            if(eliminado!=null){ // 
                System.out.println("Datos: ");
                System.out.println("Equipo   Jugados   Ganados   Empatados   Perdidos    Puntos");
...
public static void imprimirEquipo(LigaEspañola LE){
        ...
        System.out.printf("%-10s %-10d %-10d %-10d %-10d %-10d %n", LE.getnombreEquipo(), LE.getParj(), LE.getParg(), 
                LE.getPare(), LE.getParp(), LE.getpuntos());
    }
